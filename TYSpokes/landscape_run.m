...
%   algorithm. 
    ...
    deltaXAdj = -3.5:StepSize:3.5;
    deltaYAdj = -3.5:StepSize:3.5;
    FOX = 25; 
...
parfor iDx = 1:size(deltaKVec,2)
    [bOut(iDx,:),NRMSE(iDx,:),~,ExitFlag(iDx,:),OutputStruct{iDx,:}] = VE_AS(OptimType,deltaKVec(:,iDx),SINC,maskedMaps,param);
end
toc
